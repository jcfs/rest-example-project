...
<body ng-controller="atmController">
	<div class="container">
		Hello <b>${user.username}</b> (<a href="<c:url value="/logout" />">Logout</a>)
		<h2>ATM Search Utility:</h2>

		<input type="text" ng-model="city" placeholder="City Name" /><br /> <select
			name="singleSelect" ng-model="type">
			<option value="option-1">Filter Remotely</option>
			<option value="option-2">Filter Locally</option>
		</select><br /> <input type="submit" ng-click="updateResults()" value="Search" />
